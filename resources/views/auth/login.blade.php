{{-- <x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block w-full px-2 py-1 mt-1" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block w-full px-2 py-1 mt-1"
                            type="password"
                            name="password"
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="text-sm text-gray-600 ms-2 dark:text-gray-400">{{ __('Recordar contraseña') }}</span>
            </label>
        </div>
